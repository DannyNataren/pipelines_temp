...
class ResponseModel:
    @staticmethod
    def respond(status_req: str, message: str, data=None):
    ...
    @staticmethod
    def post_respond(data=None, success: bool = True, errors=None, title: str = None):
        if success:
            ...
            status_req = status.HTTP_409_CONFLICT
